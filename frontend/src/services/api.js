...
const API_BASE_URL = isLocal ? (process.env.REACT_APP_API_URL && process.env.REACT_APP_API_URL.startsWith('http') ? process.env.REACT_APP_API_URL : 'http://localhost:3001/api/v1') : '/api/v1';
